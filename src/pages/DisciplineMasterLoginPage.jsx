/**
 * DisciplineMasterLoginPage.jsx
 * SECURITY FIX: server-side auth via cloud-campus-auth Edge Function.
 */
import React, { useState } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { Shield, Lock, User, Loader2, Cloud, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        className: 'bg-orange-500/10 border-orange-500/50 text-orange-400',
      });
