 ...
 * --------------------
 * SECURITY FIX:
 * - Replaced direct DB query (name + numeric ID, no password) with
 *   server-side verification via cloud-campus-auth Edge Function.
 * - On success, issues a real Supabase JWT with role in user_metadata.
 */
import React, { useState } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { GraduationCap, Lock, User, Loader2, Cloud, ArrowLeft } from 'lucide-react';
