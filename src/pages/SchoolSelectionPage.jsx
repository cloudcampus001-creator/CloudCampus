...
const SchoolAvatar = ({ name }) => {
  ...
  return (
    <div
      className="h-11 w-11 rounded-2xl flex items-center justify-center shrink-0 font-black text-white text-sm shadow-lg"
      style={{ background: `linear-gradient(135deg, hsl(${hue},70%,55%), hsl(${(hue + 40) % 360},80%,60%))` }}
    >
